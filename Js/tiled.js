/**
 * Created by Fritz8 on 24/04/2016.
 */
...
test.prototype = {
    ...
    update: function() {
        ...
        this.directions[0] = this.map.getTileLeft(this.layer.index, this.marker.x, this.marker.y);
        this.directions[1] = this.map.getTileRight(this.layer.index, this.marker.x, this.marker.y);
        this.directions[2] = this.map.getTileAbove(this.layer.index, this.marker.x, this.marker.y);
        this.directions[3] = this.map.getTileBelow(this.layer.index, this.marker.x, this.marker.y);
